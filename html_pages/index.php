...
try {
  ...
  if (!empty($project_ids)) {
    ...
    $sql_projetos = "SELECT p.ID_Projeto, p.NomeProjeto, p.Descricao, u.Email AS EmailCriador 
                         FROM projetos p 
    ...
    <div class="right-main">
          ...
          <div class="calendar-filters">
            ...
            <div class="filter-group status-filters">
              ...
              <div class="status-checkboxes">
                <label><input type="checkbox" name="status" value="A Fazer" checked> A Fazer</label>
                <label><input type="checkbox" name="status" value="Em Andamento" checked> Em Andamento</label>
                <label><input type="checkbox" name="status" value="Concluído" checked> Concluído</label>
              </div>
            </div>
          </div>
      ...
      <div class="right-main-user-projects">
        ...
        <div class="left-main-flexible-menu">
          ...
          <div class="left-main-favorites-content-flexible-menu">
            <?php if (empty($projetos)): ?>
